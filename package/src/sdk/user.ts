...
export class User extends ClientSDK {
    ...
    async createUser(
        ...
        return unwrapAsync(userCreateUser(this, request, options));
    }
    ...
    async createUsersWithListInput(
        ...
        return unwrapAsync(userCreateUsersWithListInput(this, request, options));
    }
    ...
    async loginUser(
        ...
        return unwrapAsync(userLoginUser(this, request, options));
    }
    ...
    async logoutUser(options?: RequestOptions): Promise<void> {
        return unwrapAsync(userLogoutUser(this, options));
    }
    ...
    async getUserByName(
        ...
        return unwrapAsync(userGetUserByName(this, request, options));
    }
    ...
    async updateUser(
        ...
        return unwrapAsync(userUpdateUser(this, request, options));
    }
    ...
    async deleteUser(
        ...
        return unwrapAsync(userDeleteUser(this, request, options));
    }
}
