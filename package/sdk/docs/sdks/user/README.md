...
import { userCreateUser } from "ryan-total-test-act/funcs/userCreateUser.js";
...
async function run() {
  const res = await userCreateUser(pets, {
    id: 10,
    username: "theUser",
    firstName: "John",
    lastName: "James",
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { userCreateUsersWithListInput } from "ryan-total-test-act/funcs/userCreateUsersWithListInput.js";
...
async function run() {
  const res = await userCreateUsersWithListInput(pets, [
    {
      id: 10,
      username: "theUser",
      firstName: "John",
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { userLoginUser } from "ryan-total-test-act/funcs/userLoginUser.js";
...
async function run() {
  const res = await userLoginUser(pets, {});
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { userLogoutUser } from "ryan-total-test-act/funcs/userLogoutUser.js";
...
async function run() {
  const res = await userLogoutUser(pets);
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { userGetUserByName } from "ryan-total-test-act/funcs/userGetUserByName.js";
...
async function run() {
  const res = await userGetUserByName(pets, {
    username: "Zachery_Lubowitz15",
  });
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { userUpdateUser } from "ryan-total-test-act/funcs/userUpdateUser.js";
...
async function run() {
  const res = await userUpdateUser(pets, {
    username: "Dandre_Hand41",
    user: {
      id: 10,
      username: "theUser",
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { userDeleteUser } from "ryan-total-test-act/funcs/userDeleteUser.js";
...
async function run() {
  const res = await userDeleteUser(pets, {
    username: "Demetris_Schmitt",
  });
