...
* [createMyPet](#createmypet) - Create a pet
...
async function run() {
  const result = await petstore.pets.createMyPet({
    id: 711201,
    name: "<value>",
  });
...
```typescript
import { PetstoreCore } from "ryan-total-test-act/core.js";
import { petsCreateMyPet } from "ryan-total-test-act/funcs/petsCreateMyPet.js";
...
async function run() {
  const res = await petsCreateMyPet(petstore, {
    id: 711201,
    name: "<value>",
  });
