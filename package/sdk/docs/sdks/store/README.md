...
import { storeGetInventory } from "ryan-total-test-act/funcs/storeGetInventory.js";
...
async function run() {
  const res = await storeGetInventory(pets);
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { storePlaceOrder } from "ryan-total-test-act/funcs/storePlaceOrder.js";
...
async function run() {
  const res = await storePlaceOrder(pets, {
    id: 10,
    petId: 198772,
    quantity: 7,
    status: "approved",
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { storeGetOrderById } from "ryan-total-test-act/funcs/storeGetOrderById.js";
...
async function run() {
  const res = await storeGetOrderById(pets, {
    orderId: 614993,
  });
...
```typescript
import { PetsCore } from "ryan-total-test-act/core.js";
import { storeDeleteOrder } from "ryan-total-test-act/funcs/storeDeleteOrder.js";
...
async function run() {
  const res = await storeDeleteOrder(pets, {
    orderId: 127902,
  });
