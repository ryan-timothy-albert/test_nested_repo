...
<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=total-test&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
import {
  ...
  SDKValidationError,
} from "ryan-total-test-act/models/errors";
...
async function run() {
  let result;
  try {
    result = await pets.pet.petsStoreMonday({
      id: 10,
      name: "doggie",
      category: {
        id: 1,
...
const sdk = new Pets({ debugLogger: console });
```
<!-- End Debugging [debug] -->
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=total-test&utm_campaign=typescript)
